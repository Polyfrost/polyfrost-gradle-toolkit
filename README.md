...
plugins {
    ...
    // You can also overwrite some of these if need be. See the `org.polyfrost.defaults.loom` README section.
...
dependencies {
    ...
    modImplementation("org.polyfrost:elementa-$platform:428")
}
...
loom {
    ...
    if (platform.isLegacyForge) {
        launchConfigs.named("client") {
            arg("--tweakClass", "org.polyfrost.oneconfigwrapper.OneConfigWrapper")
